...
const username = pathParts[2];  // vì path là /profile/jerry2
const kcalChart = document.getElementById('viewKcalChart').getContext('2d');
const timeChart = document.getElementById('viewBubbleChart').getContext('2d');
